...
function insertNewTwit(twitText, twitAuthor) {
  ...
  var twitContentHTML = Handlebars.templates.twit(twitContent);
  console.log("== twitContentHTML:", twitContentHTML);

  var twitContainer = document.querySelector('.twit-container');
  twitContainer.insertAdjacentElement('beforeend', twitHTML)
  /*
