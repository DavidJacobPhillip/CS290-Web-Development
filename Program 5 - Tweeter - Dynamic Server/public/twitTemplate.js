...
templates['twit'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<article class=\"twit\">\n    <div class=\"twit-icon\">\n        <i class=\"fas fa-bullhorn\"></i>\n    </div>\n    <div class=\"twit-content\">\n        <p class=\"twit-text\">\n        "
    + alias4(((helper = (helper = lookupProperty(helpers,"text") || (depth0 != null ? lookupProperty(depth0,"text") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data,"loc":{"start":{"line":7,"column":8},"end":{"line":7,"column":16}}}) : helper)))
    + "\n        </p>\n        <p class=\"twit-author\">\n        <a href=\"#\">"
